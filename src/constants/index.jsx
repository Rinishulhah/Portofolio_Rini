...
export const icons = [
  {
    ...
    url: "https://www.linkedin.com/in/rini-shulhah-018080275/",
  },
  {
    name: "git",
    icon: (
    ...
    url: "https://github.com/Rinishulhah/Rinishulhah",
  },
];
...
export const projects = [
  {
    ...
    otherLink:
      "https://zion.luddy.indiana.edu/info-capstone-2024/healthy-bytes",
  },
  {
    title: "Outdoor Adventures",
    category: "FullStack",
    description:
      "A trip management application that enables users to seamlessly add, edit, and delete trips, as well as manage members. I gained a solid foundation of web development with this project, especially with routing and working with frameworks",
  ...
  },
  {
    ...
    category: "UI/UX",
    description:
      "EcoU is designed to address the critical issue of recycling accessibility and education. We simply recycling by providing city regulations, comphrensive recycling information, and a map feature showcasing nearby recycling centers and bins.",
    technologies: ["Figma", "Miro", "DataScraper"],
    projectImg: proj3,
    otherLink:
      "https://zion.luddy.indiana.edu/info-i370-fa23/Sathvica-Group%2004",
  },
];
